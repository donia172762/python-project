    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\e-life center\\Desktop\\commu\\communication.wav', True)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.audio_sink_0 = audio.sink(24000, '', True)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(24000, analog.GR_SIN_WAVE, 10000, 1.5, 0, 0)
